...
const Admission = ({
  ...
  return (
    <>
    <div className="hidden lg:w-full mb-5 px-8 py-2.5 section">
      ...
      <div className="w-full grid grid-cols-2 gap-4 row-gap-10 personalInfoGridadmission">
        ...
        <div>
          ...
          <button
            className={`${admissionInfo.Status ? "bg-green-500" : "bg-red-500"} px-14 py-2.5 font-bold text-xl text-white border-none outline-none rounded-md mb-5`}
          >
    ...
    <div className="w-full mb-5 px-4 py-2.5 section lg:hidden">
        ...
        <div className="w-full flex flex-col gap-6 personalInfoGridadmission">
          ...
          <div>
            ...
            <div className="w-full flex gap-3 personalInfoItemgrid">
              <div className="flex-1 contents personalInfoGridadmissionitem">
                <select
                  name="DD"
                  value={admissionInfo.admissionDate?.DD || ""}
                  onChange={handleDateChange}
                  required
                  className="px-4 py-3 rounded-md border-2 border-gray-300 text-gray-500 outline-none text-sm bg-white w-full"
                >
                  <option value="">DD</option>
                  {days.map((day) => (
                    <option key={day} value={day.toString().padStart(2, "0")}>
          ...
          <div>
            ...
            <button
              className={`${admissionInfo.Status ? "bg-green-500" : "bg-red-500"} px-8 py-2 font-bold text-lg text-white border-none outline-none rounded-md mb-5`}
            >
              {admissionInfo.Status ? " Active" : "Deactivated"}
            </button>
          </div>
