...
const MultiDropdown = ({
  ...
  return (
    <Popover className="relative w-full">
      {() => (
        <>
          <Popover.Button className="focus:border-[#0071E3] z-[100] border p-1.5 border-[#B6B6B6] inline-flex w-full justify-between rounded-sm bg-white sm:text-xs lg:text-sm text-[#808080] flex-wrap gap-2">
