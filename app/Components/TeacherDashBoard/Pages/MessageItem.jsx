...
import chatList from "../../TeacherChat";
...
const ChatItem = () => {
  ...
  return (
    <Teacherlayout>
      ...
      <div className="bg-[#F7F8FA] w-full xl:w-[85%] h-[92vh] xl:fixed p-2">
        <div className=" h-screen sm:gap-2 grid lg:grid-cols-[2fr_4.5fr] sm:grid-cols-[2fr_3fr]">
          ...
          >
            ...
            <div
              className="mt-2 overflow-auto no-scrollbar p-2"
          ...
          {selectedchat ? (
            <div className="bg-[#ffffff] grid grid-rows-[67px_0.79fr_auto] max-h-screen  ">
              ...
              <div
                className="bg-[#F7F8FA] overflow-auto no-scrollbar p-3"
