...
const TeacherProfile = () => {
  ...
  const registrationFormPath = "/Register/teacher/Registration-Form";
  ...
  useEffect(() => {
    ...
    if (storedTeacherInfo) {
      ...
      console.error("Teacher info not found in local storage");
      router.push(registrationFormPath);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasErrors && teacherInfo) {
      const formData = new FormData();
      formData.append("user.username", Username);
      formData.append("user.email", Email); // TODO: make dEmailynamic
      formData.append("user.password", Password);

      for (let key in teacherInfo) {
        formData.append(key, teacherInfo[key]);
      }
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="border border-[#d9d9d9] rounded p-1 pr-9 placeholder:text-[#0b0a0a33] placeholder:font-bold placeholder:text-xs w-full"
